...
## User Reset Button
set_property -dict { PACKAGE_PIN AG19   IOSTANDARD LVCMOS15 } [get_ports { rst }]; #IO_0_VRN_33 Sch=user_rst
...
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { seg_clk }]; #IO_L17P_T2_18 Sch=7seg_clk
set_property -dict { PACKAGE_PIN A12   IOSTANDARD LVCMOS33 } [get_ports { seg_en  }]; #IO_L17N_T2_18 Sch=7seg_en
set_property -dict { PACKAGE_PIN E11   IOSTANDARD LVCMOS33 } [get_ports { seg_sdo }]; #IO_L16N_T2_18 Sch=7seg_sdo
...
## USB-UART Interface
## NOTE: 
set_property -dict { PACKAGE_PIN F30   IOSTANDARD LVCMOS33 } [get_ports { uart_out }]; #IO_L22N_T3_16 Sch=uart_rxd_out
set_property -dict { PACKAGE_PIN G29   IOSTANDARD LVCMOS33 } [get_ports { uart_in }]; #IO_L22P_T3_16 Sch=uart_txd_in
